<aside x-data="{ collapsed: localStorage.getItem('atlas_sidebar_collapsed') === 'true' }"
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 space-y-6">
        <!-- Core Section -->
        <div>
            <div x-show="!collapsed" class="px-3 mb-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">
                Core
            </div>
            <nav class="space-y-1">
                ...
                <a href="{{ route('projects.index') }}"
                   :class="collapsed ? 'justify-center' : 'px-3'"
                   class="flex items-center py-2 rounded-lg text-sm font-medium transition {{ request()->routeIs('projects.*') ? 'bg-indigo-600 text-white font-semibold' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                    </svg>
                    <span x-show="!collapsed" class="ml-3">Projects</span>
                </a>
            </nav>
        </div>
        ...
        <div>
            ...
            <nav class="space-y-1">
                <div :class="collapsed ? 'justify-center' : 'px-3'"
                     class="flex items-center py-2 rounded-lg text-sm font-medium text-gray-600 opacity-60 cursor-not-allowed"
                     title="Service Monitoring (Coming in Phase 4)">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                    </svg>
                    <span x-show="!collapsed" class="ml-3">Services (v0.1)</span>
                </div>
            </nav>
        </div>
