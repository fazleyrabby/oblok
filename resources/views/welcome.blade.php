        ...
        <header class="sticky top-0 z-50 h-16 bg-gray-950/80 backdrop-blur border-b border-gray-800/70">
            <div class="w-full max-w-7xl mx-auto px-5 lg:px-8 h-16 flex items-center justify-between gap-4">
                <a href="/" class="flex items-center space-x-2.5" aria-label="oblok home">
                    <div class="w-8 h-8 bg-indigo-600 rounded flex items-center justify-center font-extrabold text-white text-base shadow-sm shadow-indigo-500/20">
                        O
                    </div>
                ...
                <nav class="flex items-center gap-2">
                    <a href="https://github.com/fazleyrabby/oblok" target="_blank" rel="noopener"
                       class="hidden sm:inline-flex items-center gap-2 px-3.5 py-2 text-sm text-gray-300 hover:text-white transition rounded">
                    ...
                    @auth
                        <a href="{{ route('dashboard') }}"
                           class="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold rounded transition active:scale-[0.98]">
                            Go to dashboard
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="px-4 py-2 text-sm text-gray-300 hover:text-white transition rounded">
                            Log in
                        </a>
                        <a href="{{ route('login') }}"
                           class="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold rounded transition active:scale-[0.98]">
        ...
        <main>
            <section class="relative overflow-hidden">
                ...
                <div class="relative w-full max-w-7xl mx-auto px-5 lg:px-8 pt-14 lg:pt-20 pb-16 lg:pb-24 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    <!-- Copy -->
                    <div class="max-w-xl">
                        <div class="fade-up inline-flex items-center px-3 py-1 rounded-full bg-gray-900 border border-gray-800 text-xs font-medium text-gray-300">
                        ...
                        <div class="fade-up delay-3 mt-8 flex flex-col sm:flex-row gap-3">
                            <a href="{{ route('login') }}"
                               class="inline-flex items-center justify-center px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold rounded shadow-sm transition active:scale-[0.98]">
                                Open the console
                            ...
                            <a href="https://github.com/fazleyrabby/oblok" target="_blank" rel="noopener"
                               class="inline-flex items-center justify-center px-6 py-3 bg-gray-900 hover:bg-gray-800 text-gray-200 border border-gray-700 text-sm font-semibold rounded transition active:scale-[0.98]">
                                View on GitHub
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="fade-up delay-4 relative">
                        <div class="absolute -inset-px rounded-md bg-gradient-to-b from-gray-700/60 to-transparent" aria-hidden="true"></div>
                        <div class="relative rounded-md border border-gray-800 bg-gray-950/90 overflow-hidden shadow-2xl shadow-black/40">
                            <!-- Preview window bar -->
                            <div class="flex items-center justify-between px-4 h-11 border-b border-gray-800 bg-gray-900/60">
                                ...
                                <div class="flex items-center gap-2 text-xs text-gray-500 font-mono">
                                    oblok · acme-prod
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 font-medium">
                                        Live
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="p-4 space-y-4">
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                    <div class="rounded-md border border-gray-800 bg-gray-900/50 px-3 py-2.5">
                                ...
                                <div id="hero-chart" class="rounded-md border border-gray-800 bg-gray-900/50 px-3 pt-3"></div>

                                <!-- Event feed -->
                                <div class="rounded-md border border-gray-800 divide-y divide-gray-800/70 overflow-hidden">
            ...
            <section class="w-full max-w-7xl mx-auto px-5 lg:px-8 py-16 lg:py-24">
                ...
                <div class="reveal mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    <!-- Spotlight cell -->
                    <div class="lg:col-span-2 rounded-md border border-gray-800 bg-gray-900/60 p-6 relative overflow-hidden">
                        <div class="absolute top-0 right-0 w-40 h-40 rounded-full bg-indigo-600/10 blur-3xl" aria-hidden="true"></div>
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded bg-indigo-600/15 border border-indigo-500/20 flex items-center justify-center text-indigo-400">
                    ...
                    <!-- Scheduler -->
                    <div class="rounded-md border border-gray-800 bg-gray-900/60 p-6">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded bg-indigo-600/15 border border-indigo-500/20 flex items-center justify-center text-indigo-400">
            ...
            <section class="w-full max-w-7xl mx-auto px-5 lg:px-8 pb-16 lg:pb-24">
                <div class="reveal grid grid-cols-1 md:grid-cols-3 gap-3">
                    <div class="rounded-md border border-gray-800 bg-gray-900/60 p-7">
                    ...
                    <div class="rounded-md border border-gray-800 bg-gray-900/60 p-7">
                        <div class="w-10 h-10 rounded bg-indigo-600/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400">
            ...
            <!-- Install / consolidate -->
            <section class="w-full max-w-7xl mx-auto px-5 lg:px-8 pb-16 lg:pb-24">
                <div class="reveal grid lg:grid-cols-2 gap-12 lg:gap-16 items-center rounded-md border border-gray-800 bg-gray-900/40 p-8 lg:p-12">
                    <div class="min-w-0">
                    ...
                    <div class="min-w-0">
                        <div class="rounded-md border border-gray-800 bg-gray-950 overflow-hidden">
...
<span class="text-gray-600"># open http://your-host:8080</span></pre>
            ...
            <section class="w-full max-w-7xl mx-auto px-5 lg:px-8 pb-20 lg:pb-28">
                <div class="reveal relative rounded-md border border-gray-800 bg-gray-900/60 overflow-hidden px-8 py-14 text-center">
