...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-gray-900 border border-gray-800 rounded-xl overflow-hidden shadow-2xl transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto text-gray-100"
        x-transition:enter="ease-out duration-300"
