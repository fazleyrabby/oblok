<x-app-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-gray-900 border border-gray-800 rounded-xl p-6 shadow-sm">
            ...
            <div class="relative min-h-[320px]">
                <div id="chart-loader" class="absolute inset-0 flex flex-col items-center justify-center space-y-2 text-indigo-400 bg-gray-900 z-10">
    ...
    <script>
        ...
        window.addEventListener('live-tick', fetchAnalytics);
