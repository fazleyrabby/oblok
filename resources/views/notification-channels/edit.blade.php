                    ...
                    <div id="config-fields">
                        ...
                        <div data-config="webhook" class="space-y-4">
                            <div>
                                ...
                                <x-text-input id="config_url" name="config[url]" type="url" class="mt-1 block w-full font-mono text-sm" :value="old('config.url', $notificationChannel->encrypted_config['url'] ?? '')" placeholder="https://your-endpoint.example.com/hooks/oblok" />
